...
eventRouter.post('/', [
    ...
    body('visibility').notEmpty().withMessage('Event visibililty is required'),
    ...
    body('startDate').notEmpty().isDate().withMessage('Event start date is required'),
    body('endDate').notEmpty().isDate().withMessage('Event end date is required'),
    body('totalTickets').notEmpty().withMessage('Event total Tickets is required'),
