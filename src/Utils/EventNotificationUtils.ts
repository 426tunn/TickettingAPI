...
export class EventNotificationUtils {
    static async createEventNotification(organizerId: Types.ObjectId, eventName: string, eventId: Types.ObjectId) {
        try {
    ...
    static async deleteEventNotification(organizerId: Types.ObjectId, eventName: string, eventId: Types.ObjectId) {
        try {
